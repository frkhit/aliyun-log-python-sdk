...
from aliyun.log.consumer.consumer_group_configure_responce import CreateConsumerGroupResponse
...
class LogConsumerClient(LogClient):
    ...
    def update_consumer_group(self, project, logstore, consumer_group, in_order=None, timeout=None):
        if in_order is None and timeout is None:
            raise Exception('in_order and timeout can\'t all be None')
    ...
    def update_check_point(self, project, logstore, consumer_group, shard, check_point, consumer='',
                           force_success=True):

        request = ConsumerGroupUpdateCheckPointRequest(project, logstore, consumer_group, consumer, shard, check_point,
                                                       force_success)
